...
- HTTPS on nexgigapp.com PENDING — DNS/SSL cert still provisioning; enable "Enforce HTTPS" in GitHub Pages settings once the cert is issued (fixes browser "not secure").
