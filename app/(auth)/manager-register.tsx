...
export default function ManagerRegisterScreen() {
  ...
  const handleNext = async () => {
    ...
    await markWelcomePending('manager');
...
const styles = StyleSheet.create({
  ...
  passwordInput: { flex: 1, borderWidth: 1, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 14, fontSize: 15, letterSpacing: 0 },
