  ...
  return (
    <ScreenContainer>
      ...
      <FlatList
        ...
        contentContainerStyle={[styles.list, { paddingBottom: Math.max(insets.bottom, 8) + 56 + 24 + 50 }]}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 20, paddingTop: 16, paddingBottom: 14, borderBottomWidth: 0.5,
  },
