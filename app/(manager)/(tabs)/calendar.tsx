...
const styles = StyleSheet.create({
  ...
  lineupRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 20, paddingVertical: 8 },
  lineupRowInfo: { flex: 1 },
  lineupRowTop: { flexDirection: 'row', alignItems: 'baseline', gap: 8 },
  lineupDJName: { fontSize: 15, fontWeight: '600', flexShrink: 1 },
  lineupAmount: { fontSize: 15, fontWeight: '700' },
  lineupBarLine: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4 },
