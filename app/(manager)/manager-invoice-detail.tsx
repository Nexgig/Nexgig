...
function generateInvoiceHTML(data: {
  ...
  <head>
    ...
    <style>
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .total-row { display: flex; justify-content: flex-end; align-items: center; gap: 16px; padding: 16px 0 8px; border-top: 2px solid #2563EB; }
  ...
  <body>
    ...
    <div class="footer">
      <span class="footer-text">Generated via Nexgig · nexgigapp.com</span>
