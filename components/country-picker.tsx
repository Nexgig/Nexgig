...
// Full list of world countries with flag emojis
...
export function CountryPicker({ label, value, onChange, placeholder = 'Select country' }: CountryPickerProps) {
  ...
  const handleSelect = useCallback((country: typeof COUNTRIES[0]) => {
    ...
    <>
      ...
      >
        {selected ? (
          ...
          <Text style={[styles.triggerText, { color: colors.muted }]}>{placeholder}</Text>
        )}
      ...
      >
        <View style={[styles.modal, { backgroundColor: colors.background }]}>
          ...
          <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
            <Text style={[styles.modalTitle, { color: colors.foreground }]}>{label ?? 'Select Country'}</Text>
            <Pressable
            ...
            renderItem={({ item }) => (
              <Pressable
                style={[
                  ...
                  item.name === value && { backgroundColor: colors.primary + '18' },
                ]}
