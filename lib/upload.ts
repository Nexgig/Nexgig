...
// `expo-document-picker` is a NATIVE module (added Sep 2026) — only works in a
// build that bundles it (an OTA alone can't add it). Used so an artist can send
// their OWN invoice PDF instead of the app-generated one.
 ...
 * @param pathPrefix filename prefix, e.g. `invoice-<invoiceId>`.
 */
